...
export const createColumns = ({
  ...
  onViewDetail,
  onDelete,
}: ColumnsOptions): ProColumns<API.Trip>[] => [
  {
    title: "ID",
    dataIndex: "id",
    valueType: "digit",
  ...
  },
  {
    ...
    hideInSearch: true,
    render: (_, record) => (
      <Typography.Text type="success">¥{record.tripFee}</Typography.Text>
    ),
  },
  {
    title: "调度费",
    ...
    hideInSearch: true,
    render: (_, record) => (
      <Typography.Text type="warning">¥{record.dispatchingFee}</Typography.Text>
    ),
  },
  {
    title: "强制结束",
...
export { bicycleTypeMap, tripStatusMap };
